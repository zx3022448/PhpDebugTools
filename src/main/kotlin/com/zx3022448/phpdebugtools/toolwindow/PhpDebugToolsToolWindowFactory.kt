...
import com.zx3022448.phpdebugtools.runtime.RuntimeInstallOptions
...
private fun detectThinkPhpProject(projectRoot: Path): com.zx3022448.phpdebugtools.project.ThinkPhpProjectInfo {
    return com.zx3022448.phpdebugtools.project.ThinkPhpProjectDetector.detect(
...
private fun buildMethodInvokeState(detection: com.zx3022448.phpdebugtools.project.ThinkPhpProjectInfo): ToolWindowDetailState {
