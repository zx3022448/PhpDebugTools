...
PhpDebugTools 是一个面向 ThinkPHP 项目的 PhpStorm 插件 MVP，用于在 IDE 内完成方法直调与相关运行时辅助能力。
...
3. Use the method invoke tab to search methods and fill in JSON parameters.
...
- 打开 `PHP Debug Tools` 工具窗口，确认包含概览、方法直调两个标签页。
